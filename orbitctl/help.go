...
Global options can also be configured via upper-case environment variables prefixed with "ORBITCTL_"
For example, "some-flag" => "ORBITCTL_SOME_FLAG"
...
func printCommandUsageByName(command string, missingArgument string) {
	var cmd *Command

	fmt.Fprintf(os.Stderr, "Error: Missing argument: --%s\n", missingArgument)
